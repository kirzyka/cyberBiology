...
function init() {
    ...
    for (i = 0; i < BOT_ONE_TYPE_COUNT; i++) {
        ...
        // 800+
        const initGenom = [9, 0, 54, 62, 39, 49, 16, 39, 27, 20, 20, 52, 9, 8, 45, 35, 13, 10, 8, 34, 2, 41, 8, 10, 50, 34, 21, 6, 20, 29, 40, 23, 30, 10, 11, 45, 26, 35, 2, 15, 22, 31, 54, 1, 44, 12, 3, 0, 14, 0, 4, 41, 57, 8, 44, 25, 7, 56, 44, 46, 50, 36, 4, 12];
