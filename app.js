...
function init() {
    ...
    for (i = 0; i < BOT_ONE_TYPE_COUNT; i++) {
        ...
        // 5000+
        const initGenom = [32, 58, 63, 31, 48, 4, 54, 62, 11, 18, 44, 54, 37, 57, 45, 15, 24, 45, 47, 43, 35, 18, 9, 54, 20, 0, 26, 23, 17, 33, 56, 39, 45, 24, 39, 8, 54, 2, 54, 16, 4, 2, 15, 27, 16, 5, 11, 55, 32, 38, 16, 41, 23, 18, 60, 34, 32, 7, 20, 46, 27, 51, 12, 24];
